package com.weatherprediction.dto.response;

import com.weatherprediction.dto.Suggestion;
import lombok.Data;
...
@Data
@NoArgsConstructor
public class WeatherPredictionData {
    ...
    public WeatherPredictionData(double highTemperature, double lowTemperature, double windSpeed) {
